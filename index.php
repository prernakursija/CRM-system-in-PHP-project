...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">CRM - PHP</a>
  ...
  <header class="masthead text-center text-#002147">
    <div class="masthead-content">
      <div class="container">
        <h3 class="masthead-heading mb-0">Aqua Trust                  
  CRM</h3>
...
<li><a href="viewfeedback.php">View Feedback</a></li>
  ...
  <footer class="py-5">
    <div class="container">
      <p class="m-0 text-center text-white small"> PHP - SCRMS <?= date("Y-m-d") ?></p>
    </div>
    <!-- /.container -->
  </footer>
