  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">View Issues</a></li>
      </ul>
      ...
      <h4> <span class="semi-bold">Issues</span></h4>
      <br>
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">Issue #<?php echo $row['ticket_id'];?></span> - Created on <?php echo $row['posting_date'];?>
