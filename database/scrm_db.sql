...
CREATE TABLE feedback (
    ...
    system_performance VARCHAR2(50) NOT NULL,
    water_quality VARCHAR2(50) NOT NULL,
    customer_support VARCHAR2(50) NOT NULL,
    difficulty_using VARCHAR2(50) NOT NULL,
    suggestions CLOB,
