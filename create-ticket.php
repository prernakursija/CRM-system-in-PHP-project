...
$a=mysqli_query($con,"insert into ticket(ticket_id,email_id,subject,priority,ticket,status,posting_date)  values('$tid','$email','$subject','$priority','$ticket','$st','$pdate')");
if($a)
{
