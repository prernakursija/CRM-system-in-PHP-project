  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <ul>	
      <li class="start"> <a href="dashboard.php"> <i class="icon-custom-home"></i> <span class="title">Dashboard</span> <span class="selected"></span>  </a> 
          ...
          <li ><a href="get-quote.php"> <span class="fa fa-tasks"></span>Cost Inquiry</a></li>
          <li ><a href="create-ticket.php"><span class="fa fa-ticket"></span> Create Issue</a></li>
          <li ><a href="view-tickets.php"><span class="fa fa-ticket"></span> View Issue</a></li>
