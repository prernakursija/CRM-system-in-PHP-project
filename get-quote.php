...
<input type="checkbox" name="services[]" value="installation"> Installation Service<br>
<input type="checkbox" name="services[]" value="maintenance"> Maintenance Service<br>
<input type="checkbox" name="services[]" value="filter_replacement"> Filter Replacement<br>
<input type="checkbox" name="services[]" value="amc"> Annual Maintenance Contract (AMC)<br>
<input type="checkbox" name="services[]" value="repairs"> Repairs & Troubleshooting<br>
<input type="checkbox" name="services[]" value="water_testing"> Water Quality Testing<br>
<input type="checkbox" name="services[]" value="upgrades"> Upgrades & Trade-ins<br>
<input type="checkbox" name="services[]" value="support"> Customer Support & Complaint Resolution<br>
<input type="checkbox" name="services[]" value="spare_parts"> Spare Parts Replacement<br>
<input type="checkbox" name="services[]" value="relocation"> Relocation Service<br>
                                               <div class="form-group">                                        
